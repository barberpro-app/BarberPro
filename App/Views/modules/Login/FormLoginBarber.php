    ...
    <div class="login-register-container">
        ...
        <div class="right-side">
            ...
            <form action="/login_barbershop/auth" method="POST" id="login-form" class="form">
                ...
                <input type="text" placeholder="CNPJ" id="login-cnpj" maxlenght="18" name="cnpj">
            ...
            <form id="register-form" action="/register_barbershop/save" method="POST" class="form hidden">
                <div class="form-step" id="step-1">
                    ...
                    <input type="text" placeholder="CNPJ" id="register-cnpj" name="cnpj" maxlength="18" required>
                ...
                <div class="form-step" id="step-2">
                    ...
                    <input type="text" placeholder="CEP" id="cep" name="cep" maxlenght="8" required>
...
<script src="/js/modules/api-cep.js"></script>
